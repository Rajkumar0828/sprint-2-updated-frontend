...
export const updateUserData = async (userId, editInfo) => {
  try {
    ...
    const response = await axios.put(`${API_BASE_URL}/learner/updateProfile`, formData, {
      //http://localhost:5199/lxp/learner/updateProfile/a4c928df-0ac1-442c-ae5d-f5f6b0cc4814
      headers: {
